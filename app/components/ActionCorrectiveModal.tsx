...
interface ActionCorrectiveModalProps {
  isOpen: boolean;
  onClose: () => void;
  issue: {
    key: string;
...
export default function ActionCorrectiveModal({ isOpen, onClose, issue }: ActionCorrectiveModalProps) {
        ...
        <div className="relative w-full max-w-3xl bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-200/50">
          ...
          <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200/50 bg-gradient-to-r from-gray-50 to-blue-50">
            <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 truncate">Action Corrective - {issue.key}</h2>
          ...
          <div className="p-4 sm:p-6 space-y-4 max-h-[75vh] overflow-y-auto">
            {issue.fields.customfield_10002 && issue.fields.customfield_10002 !== 'Non défini' ? (
              <div>
                <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3">Détails de l'Action Corrective</h3>
              ...
              <div className="flex items-center gap-3 text-gray-500 italic bg-white/60 backdrop-blur-sm p-4 rounded-lg border border-gray-200">
                ...
                <span>Aucune action corrective définie pour cette issue.</span>
              </div>
            )}
          </div>
